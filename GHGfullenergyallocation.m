...
CO2_wofull = tCO2 + (CO2c+CO2p+iCO2+CO2nc).*z
N2O_full= + tN2O + (N20c+iN20+N20nc+N20p).*z;
CH4_full=  tCH4 + (CH4c+iCH4+CH4nc+CH4p).*z;
CO_full=  tCO + (COc+iCO+COnc+COp).*z;
VOC_full= tVOC +(VOCc+iVOC+VOCnc+VOCp).*z ;
